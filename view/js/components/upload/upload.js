          ...
          <div class="light-upload-list-item light-upload-list-item-done light-upload-list-item-list-type-text">
            <div class="light-upload-list-item-info">
              <span>
                ...
                <a rel="noopener noreferrer" class="light-upload-list-item-name light-upload-list-item-name-icon-count-2" title="${
                  file.name
                }" href="javascrip:void(0)">${file.name}</a>
                <span class="light-upload-list-item-card-actions ">
                  <a aria-id="download" title=" ${window.lightDesign.formatMessage(
                    "upload-download-file"
                  )}">
                    <i aria-label="图标: download" title=" ${window.lightDesign.formatMessage(
                      "upload-download-file"
                    )}" tabindex="-1" class="anticon anticon-download">
                    ...
                    ${window.lightDesign.formatMessage("upload-download-file")}
                  </a>
                  <a aria-id="delete" title=" ${window.lightDesign.formatMessage(
                    "upload-delete-file"
                  )}">
                    <i aria-label="图标: delete" title=" ${window.lightDesign.formatMessage(
                      "upload-delete-file"
                    )}" tabindex="-1" class="anticon anticon-delete">
                    ...
                    ${window.lightDesign.formatMessage("upload-delete-file")}
                  </a>
                </span>
              </span>
            </div>
